...
export function CareTopicPage() {
  ...
  return <main className="section-wrap page-block care-topic-page">
    ...
    {careTopicMedia[item.slug] ? <div className="care-topic-feature-hero">
      <figure><img src={careTopicMedia[item.slug].image} alt={careTopicMedia[item.slug].alt}/><figcaption>Фото: <a href={careTopicMedia[item.slug].source} target="_blank" rel="noreferrer">Pexels</a></figcaption></figure>
