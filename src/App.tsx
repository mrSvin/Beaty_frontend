...
import { ArticlePage, ArticlesPage, CareTopicPage, CategoryPage, HairTopicPage, GuidePage, GuidesPage, HomePage, IngredientPage, IngredientsPage, NotFoundPage, ProcedurePage, ProceduresPage, SearchPage, TestPage, TestsPage } from './beauty/pages';
